          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                <!-- Check all button -->
                <div class="btn-group">
                    <div class="row">  <div class="col-md-1" style="float:left;" >
                ...
                class="form-control" v-on:input='nombre_ligne'>
                </div>
...
<td class="col4">
 <div class="row">
                      <div class="col-md-12"  v-if="demande.is_demandeur==0">
<button type="button" @click='annulerDemande(demande.etat.pivot.demande_id)' class="btn btn-block btn-outline-danger btn-sm" style="width: auto;">Annuler</button>
...
<div v-else-if="demande.etat.libelle==='Terminée Avec réserve'">
  <td class="col0"><span class="badge mt-2" style="width:20px;height:20px;    background-color: blue;">&nbsp;&nbsp;&nbsp;</span></td>                    
                    ...
                    <td class="col4">
 <div class="row">
                      <div class="col-md-12"  v-if="demande.is_dest==1">
   <button type="button" class="btn btn-block btn-outline-success btn-sm" style="width: auto;"  @click='terminerDemande(demande.etat.pivot.demande_id)'>Terminée</button>
...
for(var i=this.start*this.pagination;i<this.end*this.pagination;i++){
  this.demande_part[i-(this.start*this.pagination)]=this.demandes[i];
            ...
            onChange(){
              this.$Progress.start();
 axios.get('api/filtreEtatMajor/'+this.id_etat).then(({data})=>(
                 this.demandes=data,
                 this.open=false,
                  this.mode=1,
                 this.nextStep(),
...
$('#detailsModal').modal('show');
            ...
            loadDemandes(){
              var i=0;
               axios.get('api/demandesMajor').then(({data})=>(
                 this.demandes=data,
                 this.loaded=true,
                 this.mode=0,
                 this.open=false,
